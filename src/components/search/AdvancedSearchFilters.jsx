                    ...
                    <>
                      <button
                        ...
                        className={`w-full text-left px-3 py-2.5 rounded-lg text-sm transition-all duration-200 ${
                          !selectedLocationId ? 'bg-green-50 text-green-800 font-semibold' : 'text-gray-700 hover:bg-gray-50'
                        }`}
                      >
                        Semua Lokasi
                      </button>
                      {locations.map((location) => (
                        <button
                          ...
                          className={`w-full text-left px-3 py-2.5 rounded-lg text-sm transition-all duration-200 ${
                            selectedLocationId === location.id ? 'bg-green-50 text-green-800 font-semibold' : 'text-gray-700 hover:bg-gray-50'
                          }`}
                        >
                          {location.nama}
                        </button>

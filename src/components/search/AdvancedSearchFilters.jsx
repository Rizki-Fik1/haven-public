      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr_1fr_3rem_1fr] gap-4 items-end">
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full h-12 px-3 border border-gray-200 rounded-lg bg-white text-gray-900 text-sm focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600/20"
          >
        ...
        {/* Settings Dropdown */}
        <div className="space-y-2 relative">
          <label className="text-sm font-semibold text-transparent block text-left">
            Settings
          </label>
          <button
            type="button"
            ...
            className="w-12 h-12 border border-gray-200 rounded-lg bg-white flex items-center justify-center hover:border-indigo-600 transition-colors"
          >
